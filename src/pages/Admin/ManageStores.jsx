                        ...
                        <Menu>
                          ...
                          <MenuList>
                            ...
                            {store.status === 'pending' && (
                              <>
                                <MenuItem color="green.500">Approve Store</MenuItem>
                                <MenuItem color="red.500">Reject Store</MenuItem>
                              </>
                            )}
                            {store.status === 'active' && (
                              <MenuItem color="orange.500">Deactivate Store</MenuItem>
                            )}
                            {store.status === 'inactive' && (
                              <MenuItem color="green.500">Activate Store</MenuItem>
                            )}
                            <MenuItem color="red.500">Delete Store</MenuItem>
                          </MenuList>
                        </Menu>
                      </Td>
                    </Tr>
